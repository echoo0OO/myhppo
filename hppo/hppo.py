        ...
        for i in range(self.epochs_update):
            ...
            for data in sampler:
                ...
                if kl_dis < self.target_kl_dis:
                    ...
                    print('Early stopping at step {} due to reaching max kl. Now kl_dis is {}'.format(num_updates,
                                                                                                      kl_dis))
                ...
                if kl_con < self.target_kl_con:
                    ...
                    print('Early stopping at step {} due to reaching max kl. Now kl_con is {}'.format(num_updates,
                                                                                                      kl_con))
